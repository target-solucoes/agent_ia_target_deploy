    ...
    class Config:
        ...
        json_schema_extra = {
            "examples": [
                ...
                {
                    "column": "Data",
                    "value": {"start": "2015-01-01", "end": "2015-12-31"},
                    "operator": "between",
                    "confidence": 0.85,
                },
            ]
...
class FilterOperation(BaseModel):
    ...
    class Config:
        ...
        json_schema_extra = {
            "examples": [
                {
                    "ADICIONAR": {"UF_Cliente": "SP", "Ano": 2015},
                    "ALTERAR": {},
                    "REMOVER": {},
                    "MANTER": {},
                },
                {
                    "ADICIONAR": {},
                    "ALTERAR": {"UF_Cliente": {"from": "SP", "to": "SC"}},
                    "REMOVER": {},
                    "MANTER": {"Ano": 2015},
                },
                {
        ...
        json_schema_extra = {
            "examples": [
                ...
                },
                {
                    ...
                    "ALTERAR": {"UF_Cliente": {"from": "SP", "to": "SC"}},
                    "REMOVER": {},
                    "filter_final": {"UF_Cliente": "SC", "Ano": 2015},
                    "metadata": {
                        "confidence": 0.90,
