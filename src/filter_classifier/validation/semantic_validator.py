...
class SemanticValidator:
    ...
    def _validate_filter_value(
        ...
        if isinstance(value, str):
            # Verificar se e coluna temporal (Data, Ano, Mes) - aceitar datas
            if column in ["Data", "Ano", "Mes"]:
                return True, ""
    ...
    def validate_filter_type_consistency(
        ...
        if column_type in ["VARCHAR", "TEXT", "STRING"]:
            ...
            if isinstance(value, list) and all(isinstance(v, str) for v in value):
                return True, ""
            return False, f"Coluna {column} espera STRING, recebeu {type(value).__name__}"
        ...
        if column_type in ["INTEGER", "BIGINT", "INT"]:
            ...
            return False, f"Coluna {column} espera INTEGER, recebeu {type(value).__name__}"
